import {
  t
} from "./chunk-34XTUKTA.js";
import {
  vs
} from "./chunk-E3YXZIZZ.js";
import {
  Gi,
  Zt,
  _s
...
// node_modules/.pnpm/mermaid@10.1.0_react-dom@16.14.0_react@16.14.0/node_modules/mermaid/dist/ganttDiagram-6b6599ba.js
function Ht(t2, e) {
...
function tt(t2, e, r, n) {
  function i(a) {
    return t2(a = arguments.length === 0 ? new Date() : new Date(+a)), a;
  }
  return i.floor = function(a) {
    return t2(a = new Date(+a)), a;
  }, i.ceil = function(a) {
    ...
    if (a = i.ceil(a), c = c == null ? 1 : Math.floor(c), !(a < s) || !(c > 0))
      return y;
    do
      y.push(f = new Date(+a)), e(a, c), t2(a);
    while (f < a && a < s);
    return y;
  }, i.filter = function(a) {
    ...
    return function(T, _, I) {
      ...
      W.parse = function(V) {
        ...
        if (typeof w == "string") {
          ...
          }(P, w, C), this.init(), l && l !== true && (this.$L = this.locale(l).$L), u && P != this.format(w) && (this.$d = new Date("")), c = {};
...
//# sourceMappingURL=ganttDiagram-6b6599ba-JHJRVFDI.js.map
